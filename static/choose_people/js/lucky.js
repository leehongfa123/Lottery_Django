$(function () {
    ...
    Obj.lucky_men = $('#luckey_men_list').text().split(',').map(Number);
    console.log(Obj.lucky_men);
    ...
    function randomLuckyArr() {
        ...
        for (var i = 0; i < Obj.luckyNum; i++) {
            ...
            if (Obj.luckyResult.indexOf(random) == -1) {
                ...
                if (Obj.lucky_men.indexOf(random) == -1) {
                    if (random != 0) {

                        Obj.luckyResult.push(random);
                        Obj.lucky_men.push(random);
                    } else {
                        i--;
                    }
                } else {
